...
class TrackItem extends React.Component {
    ...
    render() {
        ...
        return (
            <li key={`audio${playlist.id}`} className="index-track-item">
                <div className="index-track-item-container">
                    {/* <img key={`img-${playlist.id}`} className="index-preview" src={playlist.imageUrl} /> */}
